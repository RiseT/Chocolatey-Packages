...
$url32          = 'https://bintray.com/cryptomator/cryptomator/download_file?file_path=Cryptomator-1.1.4-x86.exe' # download url
$url64          = 'https://bintray.com/cryptomator/cryptomator/download_file?file_path=Cryptomator-1.1.4-x64.exe' # 64bit URL here or remove - if installer contains both (very rare), use $url

$checksum32     = '37ff8bf5b1ab5830a6d67b17eec1915da972e863c4169246136ceca61f652c17'
$checksumType32 = 'sha256'
$checksum64     = '128f0a0a2be92119f187e6a4e46299eab8919f6ae748ec67b7d621fc34758312'
...
$packageArgs = @{
  ...
  checksum      = $checksum32
  checksumType  = $checksumType32 #default is md5, can also be sha1, sha256 or sha512
